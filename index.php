...
?>
    ...
    <main class="container-fluid d-flex flex-column gap-5 py-4 px-0 logo-bg" role="main">
        ...
        <section class="Herobox container py-4" aria-labelledby="hero-section-title">
            ...
            <div class="row">
                <?php
                $section_1_visibility = get_theme_mod( 'asrepoya_homepage_section_1_visibility', true );
                $section_1_category = get_theme_mod( 'asrepoya_homepage_section_1_category', '' );
                $section_1_post_count = get_theme_mod( 'asrepoya_homepage_section_1_post_count', 3 );
                
                if ( $section_1_visibility ) : ?>
                                <!-- Hero Slider Column -->
                                <div class="col-lg-8">
                ...
                <?php
                $section_2_visibility = get_theme_mod( 'asrepoya_homepage_section_2_visibility', true );
                $section_2_category = get_theme_mod( 'asrepoya_homepage_section_2_category', '' );
                $section_2_post_count = get_theme_mod( 'asrepoya_homepage_section_2_post_count', 3 );
                
                if ( $section_2_visibility ) : ?>
                                <!-- News Sidebar Column -->
                                <div class="col-lg-4">
                                    ...
                                    <aside class="post-list-vertical" role="complementary" aria-labelledby="important-news-title">
                                        ...
                                        <div class="post-list-header">
                                            <div class="header-content">
                                                ...
                                                <a href="<?php echo esc_url(get_category_link($section_2_category)); ?>" class="more-btn">
                                                    <span>بیشتر</span>
                                                    <i class="fas fa-chevron-left"></i>
                                                </a>
                                            </div>
