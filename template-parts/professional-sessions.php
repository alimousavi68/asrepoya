            ...
            <div class="col-lg-6 bg-dark-900 text-white post-section-content pe-5 order-3 order-lg-2">
                <div class="content-inner">
                    ...
                    $sessions_query = new WP_Query(array(
                        ...
                        'posts_per_page' => 1 + $professional_sessions_section_post_count,
                        'orderby' => 'date',
                        'order' => 'DESC'
                    ));
                        ...
                        <div class="featured-post-content ">
                            ...
                            <?php if ($is_session && !empty($session_host)) : ?>
                                ...
                                <div class="host-block">
                                    ...
                                    <div class="host-info">
                                        <div class="host-name text-black">میهمان: <?php echo esc_html($session_host); ?></div>
                            ...
                            <?php if ($is_session && !empty($session_host)) : ?>
                                ...
                                <div class="host-block">
                                    <div class="host-avatar">
                                        ...
                                        ?>
                                        <img src="<?php echo esc_url($host_image_url); ?>" alt="<?php echo esc_attr($host_image_url); ?>"
                                            class="rounded-circle">
                                    </div>
                                    <div class="host-info">
                                        <div class="host-name text-black">میهمان: <?php echo esc_html($session_host); ?></div>
