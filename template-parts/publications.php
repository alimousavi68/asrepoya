...
<section class="book-carousel-section  container-fluid py-5 mx-0 px-0" aria-labelledby="publications-title">
        ...
        <div class="carousel-container position-relative">
            ...
            <div class="carousel-box bg-white shadow-lg p-5">
                <div id="bookCarousel" class="carousel carousel-fade" data-bs-ride="carousel"
                    ...
                    aria-labelledby="book-carousel-label">
                    <h3 id="book-carousel-label" class="visually-hidden">کاروسل انتشارات</h3>
                    <?php
                    ...
                    <div class="carousel-inner">
                        <?php $first_item = true; while ($publications_query->have_posts()): $publications_query->the_post(); ?>
                        <!-- Slide -->
                            ...
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="book-image-container">
                                        ...
                                        <?php else: ?>
                                        <img src="https://picsum.photos/394/294?random=1"
                                            alt="<?php the_title(); ?>" class="img-fluid ">
                                        <?php endif; ?>
                                    </div>
                                </div>
