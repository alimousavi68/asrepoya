<?php
/**
 * Widget Display Template - Style 2
 * With 75x75 image on the right side
 */
...
<aside class="asrepoya-posts-widget style-2">
        ...
        <ul class="posts-list px-0">
            ...
            if ($widget_query->have_posts()) :
                while ($widget_query->have_posts()) : $widget_query->the_post();
                    ...
                    $thumbnail_url = $thumbnail_id ? wp_get_attachment_image_url($thumbnail_id, 'thumbnail') : get_template_directory_uri() . '/assets/images/default-thumbnail.jpg';
            ?>
                    <li class="post-item">
